    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
		    ...
		    <form class="form-horizontal form-label-left" action="{{ url('Immeubles') }}" method="POST">
               ...
               {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <select class="select2_group form-control" name="zone">
                        @foreach($zones as $z)
                        <option value="{{ $z->id }}">{{ $z->libelle }}</option>
                        @endforeach
                        </select>
                        </div>
                      </div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <tr>
                          ...
                          {{ csrf_field() }}
                        {{ method_field("DELETE") }}
                        <a href="{{url('appartements/'.$i->id)}}" class="btn btn-success">Detail</a>
    ...
    <a href="{{url('immeuble/Etat/'.$i->id)}}" class="btn btn-info" > Etat </a>
                          </form>
        ...
        <div class="modal-body">
            ...
            {{ csrf_field() }}
                     ...
                     <div class="form-group">
                        ...
                        <select class="select2_group form-control" name="zone">
                        @foreach($zones as $z)
                        <option @if($i->zone_id == $z->id) {{'selected'}} @endif value="{{ $z->id }}">{{ $z->libelle }}</option>
                        @endforeach
                        </select>
                        </div>
                      </div>
